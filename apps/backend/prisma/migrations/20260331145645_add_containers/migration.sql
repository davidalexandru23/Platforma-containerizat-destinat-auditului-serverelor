...
-- CreateEnum
CREATE TYPE "TemplateType" AS ENUM ('CIS_BENCHMARK', 'CIS_CONTROLS', 'NIS2', 'NIST', 'MITRE', 'SUPPLY_CHAIN', 'CONTAINER_SECURITY', 'ISO27001', 'GDPR', 'PCI_DSS', 'CUSTOM');
...
-- CreateEnum
CREATE TYPE "AuditTargetType" AS ENUM ('SERVER', 'CONTAINER');

-- CreateEnum
CREATE TYPE "CheckTargetScope" AS ENUM ('HOST', 'CONTAINER');
...
CREATE TABLE "automated_checks" (
    ...
    "onFailMessage" TEXT,
    "platformScope" JSONB,
    "targetScope" "CheckTargetScope" NOT NULL DEFAULT 'HOST',
...
CREATE TABLE "audit_runs" (
    ...
    "targetType" "AuditTargetType" NOT NULL DEFAULT 'SERVER',
...
CREATE TABLE "discovered_containers" (
    ...
    "runningAsRoot" BOOLEAN NOT NULL DEFAULT false,
    "runningAsUser" TEXT,
    "capabilities" JSONB,
    "seccompProfile" TEXT,
    "appArmorProfile" TEXT,
    "readOnlyRootfs" BOOLEAN NOT NULL DEFAULT false,
    "envVarCount" INTEGER,
    ...
    CONSTRAINT "discovered_containers_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "audit_runs_targetContainerId_idx" ON "audit_runs"("targetContainerId");
...
-- CreateIndex
CREATE INDEX "discovered_containers_serverId_idx" ON "discovered_containers"("serverId");

-- CreateIndex
CREATE INDEX "discovered_containers_serverId_running_idx" ON "discovered_containers"("serverId", "running");

-- CreateIndex
CREATE UNIQUE INDEX "discovered_containers_serverId_runtime_containerId_key" ON "discovered_containers"("serverId", "runtime", "containerId");
...
-- AddForeignKey
ALTER TABLE "discovered_containers" ADD CONSTRAINT "discovered_containers_serverId_fkey" FOREIGN KEY ("serverId") REFERENCES "servers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
